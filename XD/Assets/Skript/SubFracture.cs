...
public class SubFracture : MonoBehaviour
{
    ...
    {
        // ѕроверка соприкосновени€ с основным collisionObject
        ...
        // ѕроверка соприкосновени€ с дополнительным additionalCollisionObject
        else if (parent.additionalCollisionObject != null && collision.collider == parent.additionalCollisionObject)
        {
            parent.Fracture(collision.contacts[0].point, Vector3.zero);  // Ќе передаем силу в этом случае
        }
